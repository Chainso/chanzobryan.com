...
<div style="text-align: center; margin-bottom: 3rem;">
  <p style="font-size: 1.125rem; color: var(--text-secondary); max-width: 600px; margin: 0 auto;">
    I'm always interested in discussing reinforcement learning, distributed systems, or potential collaborations.
...
<div style="text-align: center; margin-top: 4rem;">
  ...
  <div class="grid grid-3" style="margin-top: 2rem; max-width: 800px; margin-left: auto; margin-right: auto;">
    ...
    <a href="mailto:{{ site.social.email }}" class="contact-link">
      <svg width="32" height="32" viewBox="0 0 16 16" fill="currentColor">
